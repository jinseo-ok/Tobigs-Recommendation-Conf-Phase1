...
imp_cols = ["clickout_counter_vs_interaction_counter_mean",
...
print("Read Complete2")
# df[imp_cols].compute().to_csv('../data/features/comp_v0_selected.csv',index=False)
df[imp_cols].to_csv('../data/features/comp_v0_selected.csv',index=False)
