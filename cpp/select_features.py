...
chunks = pd.read_csv("../data/comparison.csv", delimiter=',', chunksize=10**5)
header = True
for i, chunk in enumerate(chunks):
    print(i)
    chunk[imp_cols].to_csv("../data/features/comp_v0_selected.csv", header=header, mode='a', index=False)
    header = False
